...
- `scan_memory_l0.py`: scan memory file summaries before doing wide reads
- `validate_memory_module.py`: validate manifest, required files, and L0 coverage before relying on the module
