...
- `scan_memory_l0.py`: scope the current memory surface before broad reads
- `validate_memory_module.py`: confirm the module shape before and after meaningful edits

## Manual Invocation

For explicit human-invoked reflection, use `src/commands/loom-memory-reflect.md`.
