...
invoking a full objective-driver loop. Use installed `loom-drive`, or a
project-provided equivalent objective driver, when the work is a high-level
objective continuation that needs an anchor, tranche coordination, or checkpoint
fields across multiple routes.
