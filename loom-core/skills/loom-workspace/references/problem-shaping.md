...
than more prose. Use installed `loom-spike` sketch flow, or an equivalent
exploration workflow, when mockups, diagrams, screenshots, or side-by-side
variants would make the choice clearer. Evidence owns the observed artifacts;
specs and wiki own accepted behavior or explanation.
