...
ticket records. Do not use ticket states as workflow instructions or non-ticket
record statuses. Workflow-selection guidance lives in
...
Do not treat `review_required`, `complete_pending_acceptance`, or `closed` as
workflow instructions. They are ticket execution states. A fresh agent should infer
whether review, acceptance, shipping, more evidence, or more implementation is
needed from the ticket dossier and journal.
