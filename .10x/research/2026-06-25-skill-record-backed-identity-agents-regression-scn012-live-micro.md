...
- 2026-06-25: Manual inspection found candidate created
  ...
  `.agents/skills/ledger-import-fixture-replay/SKILL.md` mirror.

## Result

Pass. Candidate cleared the `.agents` mirror identity regression.

Manual inspection found:

- candidate-variant: exact source skill identity,
  `.10x/skills/ledger-import-fixture-replay/SKILL.md`;
- candidate-variant: exact `.agents` mirror identity,
  `.agents/skills/ledger-import-fixture-replay/SKILL.md`;
- candidate-variant: source and mirror files were byte-equivalent;
- candidate-variant: no speculative `.claude` or `.opencode` mirrors;
