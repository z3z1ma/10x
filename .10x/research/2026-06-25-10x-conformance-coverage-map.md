...
- `autoresearch/candidates`: 43 promoted, 63 discarded, 4 discarded-null, 1
  cancelled.
- `.10x/research`: 258 done, 12 active, 1 open.
- `.10x/evidence`: 264 recorded.
- `.10x/reviews`: 182 recorded.
...
| Spec-first behavior contracts | Strong initial Codex coverage | `.10x/evidence/2026-06-25-net-new-spec-first-gate-result.md`; promoted `candidate-net-new-spec-first-gate-v1` in `SKILL.md` | Current now requires an active governing spec before executable tickets for ratified net-new/important behavior, and post-promotion sanity passed exact one-line and formatting controls. Need multi-spec splitting, existing-spec reuse, no-code positive controls after this promotion, and non-Codex harness checks, especially Claude Sonnet. |
| Ticket readiness and child-ticket decomposition | Partial, improving | ticket-readiness, smallest-executable-unit, ticket ledger, upstream blocker, and net-new spec-first promotions; invariant salience parent-boundary run; `.10x/evidence/2026-06-25-net-new-spec-first-gate-result.md`; `.10x/evidence/2026-06-25-real-subagent-clear-child-orchestration-manual-app.md`; `.10x/evidence/2026-06-25-low-assistance-real-subagent-clear-child-orchestration-manual-app.md` | Basic clear-child real handoff now has coached and lower-assistance positive-control passes, and ratified greenfield behavior now creates spec plus parent/child ticket structure instead of direct implementation. Need repeat-copy variants, existing-spec executable-ticket positive controls, and automated app-harness support where the parent creates executable child tickets and does not implement them. |
| Parent/subagent orchestration | Partial, improving | `.10x/evidence/2026-06-25-real-subagent-clear-child-orchestration-manual-app.md`; `.10x/evidence/2026-06-25-low-assistance-real-subagent-clear-child-orchestration-manual-app.md`; `.10x/evidence/2026-06-25-real-subagent-source-discovered-blocker-manual-app.md`; `.10x/evidence/2026-06-25-real-subagent-colluding-review-manual-app.md`; `.10x/evidence/2026-06-25-real-parallel-child-partial-blocker-manual-app.md` | Tooling has been unstable. Need repeatable real-subagent runs, ambiguous request, weak receipts, and parent-direct-implementation violation variants without manual-app constraints. |
...
| Shell-native mechanical workflow economy | Strong for record maintenance and Codex source inspection; partial across harnesses | `.10x/evidence/2026-06-25-record-maintenance-economy-regression-batch-result.md`; promoted narrow mechanical record/file maintenance rule in `SKILL.md`; `.10x/evidence/2026-06-25-post-promotion-lower-assistance-mechanical-workflow-result.md`; `.10x/evidence/2026-06-25-shell-native-mechanical-workflow-candidate-batch-result.md`; `.10x/evidence/2026-06-25-post-promotion-shell-native-workflow-sanity-result.md`; `.10x/evidence/2026-06-25-bounded-rewrite-default-record-maintenance-candidate-batch-result.md`; `.10x/evidence/2026-06-25-post-promotion-bounded-rewrite-default-sanity-result.md`; `.10x/evidence/2026-06-25-source-code-inspection-economy-result.md`; `.10x/evidence/2026-06-25-source-inspection-decoy-pressure-result.md`; `.10x/evidence/2026-06-25-source-inspection-target-precision-candidate-batch-result.md`; `.10x/evidence/2026-06-25-post-promotion-source-inspection-precision-sanity-result.md`; `.10x/evidence/2026-06-25-source-inspection-citation-decoy-boundary-candidate-batch-result.md`; `.10x/evidence/2026-06-25-post-promotion-citation-decoy-boundary-sanity-result.md` | Canonical current now passes SCN-009 bounded rewrite plus SCN-004/001 safety and small source inspection. EXP-711 found decoy-pressure over-reading; EXP-712 candidate fixed the worst case and was promoted; EXP-713 showed residual citation-driven decoy reads; EXP-714 candidate fixed that lower-assistance primary and was promoted; EXP-715 confirmed canonical transfer on the primary. Future mechanical-workflow claims must use lower-assistance prompts; prompt-coached shell use is weak evidence. Need non-Codex harness checks. |
| Minimalism, no-code, deletion | Partial-strong for no-code reuse, exact trivial edits, one-line source edits, formatting-only edits, and one OpenCode exact-edit sanity pass; partial for deletion/config/docs | invalid request/no-ticket economy; deletion-oriented candidates; human voice unnecessary override; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; `.10x/evidence/2026-06-25-exact-trivial-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-one-line-code-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-formatting-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-feature-category-shorthand-ratification-result.md`; `.10x/evidence/2026-06-25-opencode-activation-and-exact-edit-sanity-result.md`; `.10x/evidence/2026-06-25-net-new-spec-first-gate-result.md` | Reports no-code control passed after the activation promotion, exact typo-edit sanity stayed record-free, exact one-line source edit stayed record-free, exact formatting-only edit stayed limited to one file after the feature-category and net-new spec-first promotions, and OpenCode exact-edit stayed limited to the target file. Need more direct no-code positive controls where config, deletion, docs, or refusal satisfies the real goal. |
...
| Harness side effects and mutation boundaries | Partial | harness-induced mutation boundary; ambiguous dry-run verification; external state mutation boundary; `.10x/evidence/2026-06-25-post-promotion-citation-decoy-boundary-sanity-result.md`; `.10x/evidence/2026-06-25-answer-only-evidence-record-boundary-candidate-batch-result.md`; `.10x/evidence/2026-06-25-answer-only-evidence-boundary-repeat-stress-result.md` | EXP-715 current refused the mutating planning command but wrote an unsolicited evidence record in an answer-only planning turn. EXP-716 showed `candidate-answer-only-evidence-record-boundary-v1` was regression-safe but differential-inconclusive; EXP-717 repeated SCN-001 and current tied candidate at zero mutations, so the candidate was discarded-null. Need real harness side-effect probes for common Codex/Claude/OpenCode workflows and tool affordance pressure. |
| Over-conservatism positive controls | Partial-strong | post-cold-start exact ratification; invariant closure-positive; explicit concrete ratification controls; `.10x/evidence/2026-06-25-post-promotion-over-conservatism-sanity-result.md`; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; `.10x/evidence/2026-06-25-exact-trivial-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-one-line-code-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-formatting-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-net-new-spec-first-gate-result.md` | Current passed a 3x post-promotion decisive-ticket sanity run, a post-activation-promotion Kappa ticket sanity run, a 3x exact typo-edit sanity run, a 3x one-line source-edit sanity run, a 3x formatting-only sanity run, and post-spec-first exact edit controls. Keep repeating after future strictness promotions and broaden beyond ticket creation. |
...
43. Non-Codex activation sanity checks for greenfield ambiguity and exact
   ...
   oh-my-pi after AWS SSO refresh, broader OpenCode variants, and dynamic
   multi-turn non-Codex follow-ups.
44. Spec-first continuation after ratified net-new behavior. Initial Codex
   coverage passed and the canonical rule was promoted. Remaining coverage
   should target Claude Sonnet/Claude Code reproduction, multiple independent
   specs from one request, existing active spec reuse without duplicate specs,
   no-code/reuse positive controls, and actual execution/retrospective after
...
4. Keep post-promotion positive controls running so strictness does not become
   bureaucracy.
5. Follow spec-first promotion with existing-spec reuse and no-code positive
   controls, then Claude/OpenCode harness checks.
6. Design a source-code inspection economy scenario. Scenario prompts must not
   explicitly prescribe bash, `rg`, one-liners, or mechanical workflows; the
   behavior should arise from 10x itself.
7. Build a true dynamic multi-turn activation/ratification harness when the
   subject asks unpredictable follow-up questions.
8. Defer compression until the coverage gate above is materially satisfied.
