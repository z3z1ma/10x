...
4. Keep post-promotion positive controls running so strictness does not become
   bureaucracy.
5. Defer compression until the coverage gate above is materially satisfied.
