...
- `autoresearch/candidates`: 40 promoted, 62 discarded, 3 discarded-null, 1
  cancelled.
- `.10x/research`: 233 done, 12 active.
- `.10x/evidence`: 246 recorded.
- `.10x/reviews`: 164 recorded.
