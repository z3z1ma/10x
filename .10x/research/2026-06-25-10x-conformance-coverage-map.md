...
- `autoresearch/candidates`: 42 promoted, 63 discarded, 4 discarded-null, 1
  cancelled.
- `.10x/research`: 250 done, 12 active, 1 open.
- `.10x/evidence`: 260 recorded.
- `.10x/reviews`: 178 recorded.
...
| Ticket readiness and child-ticket decomposition | Partial, improving | ticket-readiness, smallest-executable-unit, ticket ledger, and upstream blocker promotions; invariant salience parent-boundary run; `.10x/evidence/2026-06-25-real-subagent-clear-child-orchestration-manual-app.md`; `.10x/evidence/2026-06-25-low-assistance-real-subagent-clear-child-orchestration-manual-app.md` | Basic clear-child real handoff now has coached and lower-assistance positive-control passes. Need repeat-copy variants and automated app-harness support where the parent creates executable child tickets and does not implement them. |
...
| Minimalism, no-code, deletion | Partial-strong for no-code reuse, exact trivial edits, one-line source edits, and formatting-only edits; partial for deletion/config/docs | invalid request/no-ticket economy; deletion-oriented candidates; human voice unnecessary override; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; `.10x/evidence/2026-06-25-exact-trivial-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-one-line-code-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-formatting-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-feature-category-shorthand-ratification-result.md` | Reports no-code control passed after the activation promotion, exact typo-edit sanity stayed record-free, exact one-line source edit stayed record-free, and exact formatting-only edit stayed limited to one file after the feature-category promotion. Need more direct no-code positive controls where config, deletion, docs, or refusal satisfies the real goal. |
...
| Over-conservatism positive controls | Partial-strong | post-cold-start exact ratification; invariant closure-positive; explicit concrete ratification controls; `.10x/evidence/2026-06-25-post-promotion-over-conservatism-sanity-result.md`; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; `.10x/evidence/2026-06-25-exact-trivial-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-one-line-code-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-formatting-edit-after-activation-sanity-result.md` | Current passed a 3x post-promotion decisive-ticket sanity run, a post-activation-promotion Kappa ticket sanity run, a 3x exact typo-edit sanity run, a 3x one-line source-edit sanity run, and a 3x formatting-only sanity run. Keep repeating after future strictness promotions and broaden beyond ticket creation. |
...
42. Further multi-turn ratification after greenfield shaping checkpoints where
   ...
   feature-category shorthand coverage passed; remaining gap is a true dynamic
   user simulator rather than scripted continuation.
...
6. Build a true dynamic multi-turn activation/ratification harness when the
