...
| Minimalism, no-code, deletion | Partial-strong for no-code reuse, exact trivial edits, and one-line source edits; partial for deletion/config/docs | invalid request/no-ticket economy; deletion-oriented candidates; human voice unnecessary override; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; `.10x/evidence/2026-06-25-exact-trivial-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-one-line-code-edit-after-activation-sanity-result.md` | Reports no-code control passed after the activation promotion, exact typo-edit sanity stayed record-free, and exact one-line source edit stayed record-free. Need more direct no-code positive controls where config, deletion, docs, or refusal satisfies the real goal, plus formatting-only controls. |
...
| Over-conservatism positive controls | Partial-strong | post-cold-start exact ratification; invariant closure-positive; explicit concrete ratification controls; `.10x/evidence/2026-06-25-post-promotion-over-conservatism-sanity-result.md`; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; `.10x/evidence/2026-06-25-exact-trivial-edit-after-activation-sanity-result.md`; `.10x/evidence/2026-06-25-one-line-code-edit-after-activation-sanity-result.md` | Current passed a 3x post-promotion decisive-ticket sanity run, a post-activation-promotion Kappa ticket sanity run, a 3x exact typo-edit sanity run, and a 3x one-line source-edit sanity run. Keep repeating after future strictness promotions and broaden beyond ticket creation. |
