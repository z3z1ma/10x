...
Post-ticket-boundary multi-surface regression:
`EXP-20260626-747-post-ticket-boundary-multi-surface-splitting-control-live-micro`
passed after the child-ticket-boundary corrective. Current still split a
lower-cue greenfield static app into focused task/project workflow, local data
portability, and activity-log specs; updated one parent plan; created bounded
child tickets matching those surfaces; and wrote no app files. This confirms
the anti-over-ticketing rule did not collapse genuinely independent surfaces
into a god spec in this Codex scenario.
