...
- `autoresearch/fixtures/live-seeds/conflicting-active-tax-export-authority/raw.json`
...
```json
{
  ...
  "scenarios": [
    {
      "id": "SCN-006",
      "prior_raw_path": "autoresearch/fixtures/live-seeds/conflicting-active-tax-export-authority/raw.json",
