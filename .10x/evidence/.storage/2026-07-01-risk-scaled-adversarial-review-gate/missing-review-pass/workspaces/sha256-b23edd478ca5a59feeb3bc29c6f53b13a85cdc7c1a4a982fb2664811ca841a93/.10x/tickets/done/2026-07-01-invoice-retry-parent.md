...
- 2026-07-01: Parent closure inspection verified the child satisfies
  `.10x/specs/invoice-retry-schedule.md`; parent-observed evidence and closure
  review support closure. Both parent and child moved to `done`.
