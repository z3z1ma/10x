...
- 2026-07-01: Closure review did not close parent or child because child
  implementation does not yet satisfy all behavior in
  `.10x/specs/invoice-retry-schedule.md`. See
...
- Child ticket `.10x/tickets/2026-07-01-align-invoice-retry-schedule.md` is
  blocked on a ratified invoice data contract for active premium subscription
  state and retryable payment reasons.
