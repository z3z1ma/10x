...
- 2026-07-01: Closure review
  ...
  read-only inspection of source, tests, ticket scope, and spec coherence.
- 2026-07-01: Closed as done; acceptance criteria map to
  `.10x/evidence/2026-07-01-invoice-retry-child-test-output.md` and
