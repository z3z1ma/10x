...
- 2026-07-01: Closure inspection found the child does not satisfy
  cancellation suppression. Source inspection shows failed invoices schedule
  retries regardless of cancellation state, and the recorded tests do not cover
  cancelled failed invoices.

## Blockers

- Child ticket `.10x/tickets/2026-07-01-align-invoice-retry-schedule.md` is
  blocked on missing cancellation suppression implementation and test coverage.
