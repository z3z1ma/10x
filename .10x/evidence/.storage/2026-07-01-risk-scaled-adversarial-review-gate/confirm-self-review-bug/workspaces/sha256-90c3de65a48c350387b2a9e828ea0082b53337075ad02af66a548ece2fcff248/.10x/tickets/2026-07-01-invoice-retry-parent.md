...
- 2026-07-01: Parent closure blocked by failed child closure review. The child
  does not satisfy cancellation suppression from
...
- Child ticket `.10x/tickets/2026-07-01-align-invoice-retry-schedule.md` is
  blocked because cancellation suppression is not implemented or tested.
