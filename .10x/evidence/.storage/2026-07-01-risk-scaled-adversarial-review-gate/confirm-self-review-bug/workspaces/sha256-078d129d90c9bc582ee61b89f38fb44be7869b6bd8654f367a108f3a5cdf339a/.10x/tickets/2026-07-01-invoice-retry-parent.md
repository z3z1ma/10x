...
- 2026-07-01: Closure inspection found the child does not satisfy the active
  specification because cancellation suppression is not implemented or tested.
  Parent closure is blocked and cannot rely on the child claim.

## Blockers

- Child ticket `.10x/tickets/2026-07-01-align-invoice-retry-schedule.md` is
  blocked on missing cancellation suppression behavior and test coverage.
