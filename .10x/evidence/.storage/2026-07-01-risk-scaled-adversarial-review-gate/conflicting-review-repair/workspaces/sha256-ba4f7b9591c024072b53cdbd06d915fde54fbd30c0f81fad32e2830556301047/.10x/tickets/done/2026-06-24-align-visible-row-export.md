...
- 2026-07-01: Reconciled conflicting reviews against the active spec. The fail
  review findings were real and repaired in `src/exports/visibleRows.js` and
  `src/exports/visibleRows.test.js`; the selected-tests pass review was
  scoped too narrowly to close the active spec by itself.
- 2026-07-01: Current evidence recorded in
  `.10x/evidence/2026-07-01-visible-row-export-closure-evidence.md`.
- 2026-07-01: Current active-spec review recorded pass in
  `.10x/reviews/2026-07-01-visible-row-export-closure-review.md`.
- 2026-07-01: Closed after mapping source, tests, evidence, and review state
  back to `.10x/specs/visible-row-export.md`.
