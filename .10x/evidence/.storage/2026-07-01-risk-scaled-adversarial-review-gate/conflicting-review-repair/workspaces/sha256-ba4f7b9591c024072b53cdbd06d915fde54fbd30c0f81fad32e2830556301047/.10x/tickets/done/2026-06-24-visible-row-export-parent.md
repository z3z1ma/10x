...
- 2026-07-01: Closure inspection confirmed the fail review was still real,
  repaired the in-scope source/test gap, recorded current evidence and a
  current active-spec pass review, and closed the child ticket.
- 2026-07-01: Parent closed after confirming the child satisfies
  `.10x/specs/visible-row-export.md`, evidence covers active-spec behavior,
  and the review state is reconciled.
