...
- 2026-07-01: Repaired source and tests to satisfy active visibility and
  policy-hidden rules.
- 2026-07-01: Recorded updated evidence in
  `.10x/evidence/2026-06-24-visible-row-export-test.md` and pass closure review
  in `.10x/reviews/2026-07-01-visible-row-export-closure-review.md`.
- 2026-07-01: Closed after reconciling the conflicting reviews against the
