...
- 2026-07-01: Closure inspection found cancellation suppression is not implemented or tested; see `.10x/reviews/2026-07-01-invoice-retry-closure-review.md`.

## Blockers

- `shouldScheduleRetry` does not suppress retry scheduling when the invoice/account is cancelled.
- `src/billing/retrySchedule.test.js` does not cover cancellation suppression required by `.10x/specs/invoice-retry-schedule.md`.
