...
- 2026-07-01: Closure review failed because the child does not yet satisfy the
  cancellation suppression requirement; see
...
- Child ticket `.10x/tickets/2026-07-01-align-invoice-retry-schedule.md` is
  blocked on cancellation suppression implementation and test coverage.
