...
- 2026-07-01: Closure review failed. Parent inspection found cancellation
  suppression is neither implemented nor tested; see
  `.10x/reviews/2026-07-01-invoice-retry-closure-review.md`.

## Blockers

- Implement and test cancellation suppression for failed invoices before
  closure.
