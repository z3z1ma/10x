...
| --- | --- | --- | --- |
| `using-superpowers` | Mandatory skill activation and platform tool mapping. | `using-loom`, `loom-workspace`, harness adapters. | Already owned. Preserve Loom's using-Loom-first doctrine and route-by-truth-owner model; do not import the 1% trigger rule because it would create ceremony and weak skill activation. |
