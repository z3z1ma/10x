...
ID: ticket:20260510-product-surface-language-cleanup
Type: Ticket
Status: closed
Created: 2026-05-10
Updated: 2026-05-11
Risk: medium - changes shipped instruction wording and public docs after review feedback.
...
- `plan:20260510-core-loop-hardening` - prior completed hardening plan that this follow-up corrects.
- `audit:20260510-loop-hardening-review` - prior fresh review that is superseded for language-leakage concerns by this follow-up.
- `evidence:20260510-product-surface-language-cleanup-checks` - command and search evidence for this ticket.
- `audit:20260511-product-surface-language-cleanup-review` - final fresh-context review for this ticket.
- `packet:20260511T070642Z-product-surface-language-review` - prior review packet that found two public-doc wording leaks.
- `packet:20260511T071542Z-product-surface-language-final-review` - final review packet after those findings were fixed.
...
- ACC-001: Shipped skill bodies no longer use package-boundary guidance such as `Core Dependency`, `Use loom-core first`, `Core routing`, or `Playbooks over Core` to explain workflow precedence.
  ...
  - Result: satisfied by `evidence:20260510-product-surface-language-cleanup-checks` and `audit:20260511-product-surface-language-cleanup-review`.
...
- 2026-05-11: Consumed `packet:20260511T070642Z-product-surface-language-review`; fresh review returned `changes-needed` for two public-doc wording leaks in `loom-playbooks/README.md` and `ARCHITECTURE.md`.
- 2026-05-11: Patched both public-doc findings to route wording through `Loom records` rather than `Core` or `Core records`.
- 2026-05-11: Reran final package smoke, pack checks, `git diff --check`, shipped skill searches, public-doc package-boundary searches, and eval-term searches; results recorded in `evidence:20260510-product-surface-language-cleanup-checks`.
- 2026-05-11: Consumed `packet:20260511T071542Z-product-surface-language-final-review`; final fresh review returned `clear` with no material findings.
