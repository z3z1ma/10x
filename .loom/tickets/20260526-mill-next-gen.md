...
3. **Shaping sessions**: A fundamentally new interaction paradigm for the Design
   Room. See `.loom/specs/mill-shaping-sessions.md` for the full behavioral contract. This
   is the highest-leverage feature and needs phased implementation starting with
   the staging area concept.

## Related Records

- `.loom/specs/mill-shaping-sessions.md` - behavioral contract for the shaping experience
- `.loom/specs/mill-design-room.md` - Design Room current behavior
- `.loom/specs/mill-factory-floor.md` - Factory Floor current behavior
- `.loom/tickets/20260526-mill-factory-data-integrity.md` - just completed, fixes data pipeline
...
Ticket: .loom/tickets/20260526-mill-review-ux.md
...
Ticket: .loom/tickets/20260526-mill-graph-connected.md
...
Ticket: .loom/tickets/20260526-mill-graph-dag.md
...
First implementation slice of `.loom/specs/mill-shaping-sessions.md`. The MVP likely includes:
...
Child tickets: .loom/tickets/20260526-mill-review-ux.md
...
Child tickets: .loom/tickets/20260526-mill-graph-connected.md, .loom/tickets/20260526-mill-graph-dag.md
