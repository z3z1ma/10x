...
Legacy note: Risk — medium - core data model change affects persistence, API, WebSocket, and all downstream tickets

Depends-On: .loom/tickets/done/20260526-mill-canvas-svelvet-proof.md
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-002 through REQ-012 define node types, statuses,
  and interaction semantics the model must support
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 2
...
Evidence: `.loom/evidence/20260526-mill-canvas-graph-tests.md` records `uv run pytest
...
- 2026-05-26: Set Status `review`. Implemented graph model and updated shaping
  ...
  tests. Evidence recorded in `.loom/evidence/20260526-mill-canvas-graph-tests.md`.
