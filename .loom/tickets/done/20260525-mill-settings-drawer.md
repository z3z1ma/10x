...
Legacy note: Risk — low - moving existing components into a slide-out drawer; adding one small backend endpoint.
...
- `.loom/tickets/done/20260525-mill-layout-overhaul.md` - removes the sidebar; this ticket provides the replacement
