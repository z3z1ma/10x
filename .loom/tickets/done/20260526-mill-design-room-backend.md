...
Legacy note: Risk — high - harness subprocess management with streaming is architecturally novel for this codebase
...
- `.loom/specs/mill-design-room.md` - full behavior contract (interface contract section)
...
- ACC-001: `PUT /records/.loom/tickets/done/20260526-mill-foundation-fixes.md` updates the file on disk and the watcher broadcasts RecordChanged
...
Evidence: `.loom/evidence/20260526-mill-design-room-backend-tests.md` records the full
