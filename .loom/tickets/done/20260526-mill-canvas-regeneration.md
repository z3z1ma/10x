...
Legacy note: Risk — high - most novel and complex feature; dependency tracking, invalidation cascades, re-invocation loops, and concurrent state management all intersect

Depends-On: .loom/tickets/done/20260526-mill-canvas-e2e-tracer.md
Depends-On: .loom/tickets/done/20260526-mill-canvas-interaction.md
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-012 defines reactive regeneration behavior
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 7
- `.loom/tickets/done/20260526-mill-canvas-interaction.md` — provides option selection and dead
  branch mechanics; regeneration builds on similar graph-mutation patterns
- `.loom/tickets/done/20260526-mill-canvas-graph-model.md` — node model must support `stale` status
...
Evidence: `.loom/evidence/20260526-mill-canvas-regeneration-validation.md`
...
- 2026-05-26: Implemented backend edit/reselect regeneration, session stale/active
  ...
  recorded in `.loom/evidence/20260526-mill-canvas-regeneration-validation.md`. Status set
