...
Legacy note: Risk — low - cosmetic improvements across components, no structural changes.
...
- `.loom/tickets/done/20260525-mill-layout-overhaul.md` - provides the new component structure to polish
