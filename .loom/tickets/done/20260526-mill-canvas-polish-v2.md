...
Legacy note: Risk — medium - state machine UX changes touch the core interaction loop; canvas theming is visual-only
...
- `.loom/specs/mill-shaping-canvas.md` — governing spec
- `.loom/tickets/20260526-mill-shaping-canvas.md` — completed canvas plan
- `.loom/decisions/no-backward-compat-own-stack.md` — no legacy code maintenance
...
Ticket: proposed ticket `20260526-mill-canvas-state-machine`
...
Ticket: proposed ticket `20260526-mill-canvas-theme`
...
Ticket: proposed ticket `20260526-mill-canvas-parser-hardening`
...
Ticket: proposed ticket `20260526-mill-canvas-admin-cleanup`
...
Child tickets: proposed ticket `20260526-mill-canvas-state-machine`
...
Child tickets: proposed ticket `20260526-mill-canvas-theme`
