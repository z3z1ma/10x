...
Legacy note: Risk — medium - large structural refactor touching App.svelte and most layout components; must not break existing WebSocket/state wiring.
...
- `.loom/specs/mill-factory-floor.md` REQ-010, REQ-011, REQ-012 - pipeline, panels, andon
