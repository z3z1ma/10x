...
Legacy note: Risk — medium - parallel worktree merging can produce conflicts; git operations need careful sequencing.
...
- `.loom/specs/mill-shipping-dock.md` REQ-001 through REQ-011 - full behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 6 - parent plan
- `.loom/tickets/done/20260525-mill-multi-workstation.md` - prerequisite (provides workstation lifecycle)
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 6.
