...
Legacy note: Risk — medium - changes generated command metadata and smoke expectations around explicit Playbook macro surfaces.
...
- `.loom/specs/playbook-explicit-macros.md#REQ-013` - defines the intended command-description behavior.
- `.loom/research/20260516-product-surface-scan.md` - identified the generated description polish issue.
- `.loom/specs/playbook-explicit-macros.md` - preserves the broader explicit macro behavior and no-autoactivation contract.
- `.loom/tickets/done/20260515-playbook-explicit-macro-docs-tests.md` - prior docs/tests ticket for explicit Playbook behavior.
...
`.loom/specs/playbook-explicit-macros.md`, `loom-playbooks/loom-playbooks.mjs`, and a sample
...
Validation is preserved in `.loom/evidence/20260516-product-surface-ticket-validation.md`.
Ralph review `.loom/reviews/20260516-product-surface-ticket-review.md` found this ticket
...
- 2026-05-16: Created ticket from operator disposition of `.loom/research/20260516-product-surface-scan.md` recommendation 2; operator wants existing Playbook descriptions without the generated explicitness prefix.
...
- 2026-05-16: Recorded validation dossier
  `.loom/evidence/20260516-product-surface-ticket-validation.md` and Ralph review
  `.loom/reviews/20260516-product-surface-ticket-review.md`; audit found this ticket
