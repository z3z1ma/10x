...
Created: 2026-05-25
Updated: 2026-05-25
Depends-On: .loom/tickets/done/20260525-mill-pipeline-ui.md, .loom/tickets/done/20260525-mill-workstation-engine.md

Legacy note: Risk — medium - convergence point connecting visibility and execution; integration complexity.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan, Unit 6 (convergence point).
- `.loom/specs/loom-mill-factory-floor-mvp.md` REQ-004, REQ-006 - harness config is operator-selectable; pause/stop controls exist.
...
- 2026-05-25: Created from `.loom/tickets/20260525-factory-floor-mvp.md` Unit 6.
