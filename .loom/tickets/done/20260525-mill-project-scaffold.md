...
Legacy note: Risk — low - greenfield scaffolding with known tools, no production behavior yet.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan, Unit 1.
- `.loom/specs/loom-mill-factory-floor-mvp.md` - behavior contract; this ticket only scaffolds, does not implement requirements yet.

## Scope

Read scope:
- `.loom/specs/loom-mill-factory-floor-mvp.md` RD-003, RD-004, RD-005 for stack decisions.
...
- 2026-05-25: Created from `.loom/tickets/20260525-factory-floor-mvp.md` Unit 1.
