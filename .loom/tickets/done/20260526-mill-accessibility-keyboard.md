...
Legacy note: Risk — medium - keyboard handling is easy to regress; ARIA requires careful testing

Priority: high - unusable without mouse; fails basic a11y
Depends-On: .loom/tickets/done/20260526-mill-interaction-completeness.md
...
- `.loom/tickets/done/20260526-mill-interaction-completeness.md` - must land first (all interactions working)
