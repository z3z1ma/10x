...
Legacy note: Risk — low - straightforward git diff capture and JSON persistence; main concern is race conditions between commit detection and subprocess activity.
...
- `.loom/specs/mill-factory-floor.md` REQ-004, REQ-005, REQ-008, REQ-017 - behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 3 - parent plan
- `.loom/tickets/done/20260525-mill-multi-workstation.md` - prerequisite
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 3.
