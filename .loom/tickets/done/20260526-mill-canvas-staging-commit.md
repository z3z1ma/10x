...
Legacy note: Risk — medium - session resume must preserve full canvas state (node positions, selections, dead branches); data loss on refresh would break trust
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-004 (record nodes feed staging), REQ-009
  (staging panel), REQ-010 (session persistence and resume)
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 9
- `.loom/tickets/done/20260526-mill-canvas-interaction.md` — provides record node accept/reject
  actions
...
Evidence: `.loom/evidence/20260526-mill-canvas-staging-commit-build.md`.
