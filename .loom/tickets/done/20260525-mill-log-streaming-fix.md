...
Legacy note: Risk — medium - requires investigating how `opencode run` writes to stdout/stderr when piped; may need PTY workaround.
...
- `.loom/specs/mill-factory-floor.md` REQ-003 - full stdout/stderr streaming per workstation
