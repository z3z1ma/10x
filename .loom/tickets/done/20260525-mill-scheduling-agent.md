...
Created: 2026-05-25
Updated: 2026-05-25
Depends-On: .loom/tickets/done/20260525-mill-multi-workstation.md

Legacy note: Risk — medium - dependency resolution from semi-structured records requires robust parsing; LLM heijunka advisory adds external dependency.
...
- `.loom/specs/mill-scheduling-agent.md` REQ-001 through REQ-009 - full behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 5 - parent plan
- `.loom/tickets/done/20260525-mill-multi-workstation.md` - prerequisite (provides workstation lifecycle events)
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 5.
