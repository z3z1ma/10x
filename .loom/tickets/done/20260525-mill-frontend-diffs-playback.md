...
Legacy note: Risk — low - UI rendering of diffs and timeline navigation; main concern is large diff performance.
...
- `.loom/specs/mill-factory-floor.md` REQ-006, REQ-007 - behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 8 - parent plan
- `.loom/tickets/done/20260525-mill-iteration-history.md` - provides iteration history API
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 8.
