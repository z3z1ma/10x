...
Legacy note: Risk — medium - Svelvet custom node API constraints unknown until proof completes; interaction affordances inside nodes may be limited
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-002 defines node types and visual treatment;
  REQ-003 defines dead branch styling; REQ-008 defines interaction affordances
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 4
- `.loom/tickets/done/20260526-mill-canvas-svelvet-proof.md` — provides the Svelvet integration
