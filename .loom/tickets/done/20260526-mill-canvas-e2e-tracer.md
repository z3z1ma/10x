...
Legacy note: Risk — high - integrates all contracts (model, protocol, components, WebSocket); first point where mismatches surface

Depends-On: .loom/tickets/done/20260526-mill-canvas-graph-model.md
Depends-On: .loom/tickets/done/20260526-mill-canvas-response-protocol.md
Depends-On: .loom/tickets/done/20260526-mill-canvas-node-components.md
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-001, REQ-006, REQ-007 govern the rendering
  and progressive growth behavior
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 5
- `.loom/tickets/done/20260526-mill-canvas-graph-model.md` — provides backend graph model and API
- `.loom/tickets/done/20260526-mill-canvas-response-protocol.md` — provides parser for multi-node
  output
- `.loom/tickets/done/20260526-mill-canvas-node-components.md` — provides renderable node
  components
