...
Created: 2026-05-25
Updated: 2026-05-25
Depends-On: .loom/tickets/done/20260525-mill-workstation-engine.md, .loom/tickets/done/20260525-mill-pipeline-ui.md

Legacy note: Risk — medium - pattern detection thresholds affect false-positive/negative tradeoff; getting this wrong either annoys or misleads the operator.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan, Unit 9.
- `.loom/specs/loom-mill-factory-floor-mvp.md` REQ-009, REQ-010, SCN-005 - backpressure and andon behavior.
- `.loom/research/20260524-loom-mill-software-factory.md` Finding 8 - jidoka/autonomation, andon cord, statistical process control.
...
- 2026-05-25: Created from `.loom/tickets/20260525-factory-floor-mvp.md` Unit 9.
