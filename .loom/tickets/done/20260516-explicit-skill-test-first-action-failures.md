...
Legacy note: Risk — medium - live OpenCode log parsing may be noisy, but the test currently tolerates a doctrine violation.
...
- `.loom/research/20260516-product-surface-scan.md` - identified the warning-vs-failure gap.
- `loom-core/skills/using-loom/references/01-activation-discipline.md` - owns first-action skill invocation doctrine.
- `.loom/knowledge/playbook-activation-tests-procedure.md` - related activation-test procedure for negative Playbook checks.
- `.loom/tickets/done/20260513-superpowers-style-activation-doctrine.md` - historical activation-test strengthening context.
...
`.loom/reviews/20260516-product-surface-ticket-review.md#FIND-001` and the follow-up Ralph
...
Final Ralph review `.loom/reviews/20260516-explicit-skill-first-action-final-review.md` found
...
- 2026-05-16: Created ticket from operator disposition of `.loom/research/20260516-product-surface-scan.md` recommendation 4; operator approved trying the stricter failure posture.
...
- 2026-05-16: Recorded validation dossier
  ...
  `.loom/reviews/20260516-product-surface-ticket-review.md`. Audit returned
...
- 2026-05-16: Recorded final Ralph review
  `.loom/reviews/20260516-explicit-skill-first-action-final-review.md`; it found no material
