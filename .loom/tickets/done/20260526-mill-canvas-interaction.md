...
Legacy note: Risk — medium - interaction state machine complexity; dead branch propagation must be complete and correct
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-003 (branching/selection), REQ-008 (node
  interaction), REQ-002 (visual states)
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 6
- `.loom/tickets/done/20260526-mill-canvas-e2e-tracer.md` — provides working canvas with nodes
  and edges; this ticket adds interaction on top
- `.loom/tickets/done/20260526-mill-canvas-node-components.md` — components already have
...
Evidence: `.loom/evidence/20260526-mill-canvas-interaction-validation.md`
