...
Legacy note: Risk — medium - rendering arbitrary Markdown requires careful sanitization and styling

Priority: high - the biggest visible feature gap; users see "future work" text
Depends-On: .loom/tickets/done/20260526-mill-foundation-fixes.md
...
- `.loom/tickets/20260526-mill-production-readiness.md` - parent plan
- `.loom/tickets/done/20260526-mill-foundation-fixes.md` - must land first (types + API config)
...
- ACC-006: Backend endpoint `GET /records/{record_id}/content` returns raw Markdown
  - Evidence: `curl http://localhost:8765/records/.loom/tickets/done/20260526-mill-foundation-fixes.md/content` returns the file contents
