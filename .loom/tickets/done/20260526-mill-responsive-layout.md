...
Legacy note: Risk — low - CSS-only changes with well-defined breakpoints
...
- `.loom/tickets/done/20260526-mill-interaction-completeness.md` - interactions must work before responsive testing
