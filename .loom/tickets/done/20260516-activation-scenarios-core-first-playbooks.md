...
Legacy note: Risk — low - narrow fixture/documentation correction for activation scenario expectations.
...
- `.loom/research/20260516-product-surface-scan.md` - identified the stale activation scenario drift.
- `.loom/specs/playbook-explicit-macros.md` - defines Playbooks as explicit workflow macros rather than natural-prompt activation owners.
- `.loom/knowledge/playbook-activation-tests-procedure.md` - explains the negative activation-test posture for natural prompts.
...
- ACC-003: Activation scenario wording remains consistent with the explicit
  ...
  - Evidence: source inspection against `.loom/specs/playbook-explicit-macros.md` and
...
`.loom/reviews/20260516-product-surface-ticket-review.md` found this ticket closeable with no
material findings. Residual risk is limited to the fixture nature of the change;
no live harness eval was run.

## Journal

- 2026-05-16: Created ticket from operator disposition of `.loom/research/20260516-product-surface-scan.md` recommendation 1.
