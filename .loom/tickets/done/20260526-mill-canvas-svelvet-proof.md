...
Legacy note: Risk — high - Svelvet declares peer dep svelte >=3.59.2 || ^4.0.0; our frontend uses Svelte 5. If incompatible, entire canvas plan pivots.
...
- `.loom/specs/mill-shaping-canvas.md` — governs the canvas UX; Svelvet is the chosen
  rendering technology per resolved decisions
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 1 (risk-first)
