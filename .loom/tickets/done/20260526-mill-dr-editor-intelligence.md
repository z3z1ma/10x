...
Legacy note: Risk — medium - CodeMirror extensions are well-documented but require careful integration
...
- Selecting one inserts the full ID (e.g., `.loom/tickets/done/20260526-mill-foundation-fixes.md`)
...
- ACC-001: Record references (`.loom/tickets/<ticket-slug>.md`) render as accent-colored underlined text
