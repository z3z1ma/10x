...
Legacy note: Risk — low - straightforward async IO piping; main concern is memory management for long-running subprocesses.
...
- `.loom/specs/mill-factory-floor.md` REQ-003, REQ-015 - behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 2 - parent plan
- `.loom/tickets/done/20260525-mill-multi-workstation.md` - prerequisite (provides multi-workstation engine)
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 2.
