...
Legacy note: Risk — medium - core concurrency change to the workstation engine; asyncio subprocess management at scale needs careful design.
...
- `.loom/specs/mill-factory-floor.md` REQ-001, REQ-002, REQ-009, REQ-015, REQ-017, REQ-018 - behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 1 - parent plan
...
- `.loom/specs/mill-factory-floor.md` (behavior contract)
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 1. First move: read existing workstation engine, design N-concurrent architecture, implement.
