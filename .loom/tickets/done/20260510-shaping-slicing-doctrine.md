...
Legacy note: Risk — medium - changes Core guidance that future agents use to decide whether work is shaped enough to execute.
...
- `.loom/research/20260510-loom-loop-failure-analysis.md` - explains the observed failure modes.
...
- 2026-05-10: Created and set active from `.loom/tickets/20260510-core-loop-hardening.md`.
