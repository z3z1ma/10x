...
Legacy note: Risk — low - purely visual/CSS changes with no backend or behavioral impact.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan for the Factory Floor MVP.
- `.loom/specs/loom-mill-factory-floor-mvp.md` REQ-012, Quality Bar - control room aesthetic, execution situational awareness.
