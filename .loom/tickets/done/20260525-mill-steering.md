...
Created: 2026-05-25
Updated: 2026-05-25
Depends-On: .loom/tickets/done/20260525-mill-operator-controls.md

Legacy note: Risk — low - builds on existing pause/resume mechanics; main complexity is ensuring fresh state on resume.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan, Unit 7.
- `.loom/specs/loom-mill-factory-floor-mvp.md` REQ-007, SCN-003 - steering behavior contract.
...
- 2026-05-25: Created from `.loom/tickets/20260525-factory-floor-mvp.md` Unit 7.
