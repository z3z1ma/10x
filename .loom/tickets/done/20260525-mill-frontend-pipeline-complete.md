...
Created: 2026-05-25
Updated: 2026-05-25
Depends-On: .loom/tickets/done/20260525-mill-spc-jidoka.md, .loom/tickets/done/20260525-mill-scheduling-agent.md, .loom/tickets/done/20260525-mill-shipping-dock.md

Legacy note: Risk — low - UI rendering work integrating signals from multiple backend systems.
...
- `.loom/specs/mill-factory-floor.md` REQ-010, REQ-012, REQ-013, REQ-014 - behavior contract
- `.loom/tickets/20260525-production-factory-floor.md` Unit 9 - parent plan
- `.loom/tickets/done/20260525-mill-spc-jidoka.md` - provides SPC signals for andon board
- `.loom/tickets/done/20260525-mill-scheduling-agent.md` - provides queue state for pipeline
- `.loom/tickets/done/20260525-mill-shipping-dock.md` - provides shipping events for changelog
...
- 2026-05-25: Created ticket. Source: `.loom/tickets/20260525-production-factory-floor.md` Unit 9.
