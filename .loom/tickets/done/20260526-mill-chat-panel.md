...
Legacy note: Risk — high - harness subprocess streaming is the most architecturally complex piece

Priority: high - the interaction model that makes the Design Room special
Depends-On: .loom/tickets/done/20260526-mill-design-room-backend.md
...
- `.loom/specs/mill-design-room.md` - REQ-010, REQ-011, REQ-012, REQ-018, REQ-019, REQ-020
- `.loom/tickets/20260526-mill-design-room.md` - parent plan
- `.loom/tickets/done/20260526-mill-design-room-backend.md` - provides the chat API endpoints
