...
Legacy note: Risk — medium - CodeMirror 6 integration requires new npm dependency and careful state management for live updates
...
- `.loom/specs/mill-design-room.md` - REQ-006, REQ-007, REQ-008, REQ-009
