...
Legacy note: Risk — low - wiring existing events and adding error handling to existing fetches
...
- `.loom/tickets/done/20260526-mill-foundation-fixes.md` - provides centralized API + error patterns
