...
Legacy note: Risk — medium - changes core skill language that controls worker handoff and audit routing semantics.
...
- `.loom/tickets/done/20260510-ralph-audit-handoff-doctrine.md` - prior bounded work that made on-disk Ralph packets the worker and audit handoff contract.
- `.loom/research/20260510-loom-loop-failure-analysis.md` - identifies the earlier failure mode where worker handoffs could bypass Ralph.
...
- `.loom/tickets/done/20260513-ralph-language-consolidation.md`
...
- `.loom/evidence/20260513-ralph-language-consolidation-checks.md` - targeted term scans, source-diff inspection, smoke checks, pack checks, and `git diff --check` for this terminology consolidation.
...
- 2026-05-13: Updated shipped Core and Playbooks skill prose plus non-historical docs to center Ralph packets/Ralph-backed audit instead of context-shape terminology; recorded `.loom/evidence/20260513-ralph-language-consolidation-checks.md`; closed after acceptance evidence passed.
