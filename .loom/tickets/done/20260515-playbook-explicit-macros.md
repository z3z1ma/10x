...
Legacy note: Risk — medium - changes shipped package surfaces, adapter manifests, and activation expectations across supported harnesses.
...
- `.loom/specs/playbook-explicit-macros.md` - defines the intended behavior, requirements, scenarios, and harness-specific limits this plan implements.
- `.loom/research/20260515-playbook-command-surfaces.md` - identifies each supported harness's command or explicit-only skill surface and the Codex limiting case.
- `.loom/research/20260515-playbooks-core-activation-pressure.md` - explains why broad automatic Playbook activation should be replaced.
- `.loom/evidence/20260515-playbook-activation-stacking.md` - preserves observed Playbook stacking and current test gaps.
...
Ticket: .loom/tickets/done/20260515-playbook-macro-catalog.md
...
Ticket: .loom/tickets/done/20260515-opencode-playbook-commands.md
...
This depends on `.loom/tickets/done/20260515-playbook-macro-catalog.md`. Evidence should include source inspection plus `npm --prefix loom-playbooks run smoke`, `npm --prefix loom-playbooks run pack:check`, and `git diff --check` or a documented narrower equivalent if later package changes alter the command set.

### Unit: Claude Cursor Codex Explicit-Only Surfaces

Ticket: .loom/tickets/done/20260515-native-playbook-explicit-surfaces.md
...
This depends on `.loom/tickets/done/20260515-playbook-macro-catalog.md`. Evidence should include source inspection of manifests and explicit-only metadata, plus native plugin validation commands where available and applicable.

### Unit: Relocate Playbook Skill Corpus

Ticket: .loom/tickets/done/20260515-playbook-skill-corpus-relocation.md
...
Ticket: .loom/tickets/done/20260515-gemini-playbook-commands.md
...
This depends on `.loom/tickets/done/20260515-playbook-skill-corpus-relocation.md`. Evidence should include source inspection of command TOML files, confirmation that top-level `loom-playbooks/skills/` is absent, `gemini extensions validate "$PWD/loom-playbooks"`, root validation if root manifests are touched, and `git diff --check`.

### Unit: Documentation Tests And Final Validation

Ticket: .loom/tickets/done/20260515-playbook-explicit-macro-docs-tests.md
...
Child tickets: .loom/tickets/done/20260515-playbook-macro-catalog.md
...
Child tickets: .loom/tickets/done/20260515-opencode-playbook-commands.md, .loom/tickets/done/20260515-native-playbook-explicit-surfaces.md, .loom/tickets/done/20260515-playbook-skill-corpus-relocation.md, .loom/tickets/done/20260515-gemini-playbook-commands.md
...
Child tickets: .loom/tickets/done/20260515-playbook-explicit-macro-docs-tests.md
...
- 2026-05-15: Created plan from `.loom/specs/playbook-explicit-macros.md` and `.loom/research/20260515-playbook-command-surfaces.md` with five child execution units.
- 2026-05-15: Closed `.loom/tickets/done/20260515-playbook-macro-catalog.md` after implementation and clear Ralph audit; adapter command and explicit-only surface tickets are now unblocked.
...
- 2026-05-16: Retrospective promotion created `.loom/knowledge/playbook-activation-tests-procedure.md` to preserve the all-Playbook negative-check lesson from the final audit loop.
