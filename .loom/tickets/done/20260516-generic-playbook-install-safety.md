...
Legacy note: Risk — medium - changes install guidance around Playbook exposure and could affect users of generic skill-directory setups.
...
- `.loom/research/20260516-product-surface-scan.md` - identified the generic install sharp edge.
- `.loom/specs/playbook-explicit-macros.md` - defines Playbooks as explicit macros or explicit-only skills.
- `.loom/knowledge/playbook-activation-tests-procedure.md` - explains why natural prompts should fail on any Playbook invocation.
...
`.loom/specs/playbook-explicit-macros.md`, `INSTALL.md`, root/package READMEs, and any docs
...
- ACC-003: Docs continue to describe supported explicit Playbook surfaces for
  ...
  - Evidence: source inspection against `.loom/specs/playbook-explicit-macros.md` and relevant
    install sections.
...
`.loom/evidence/20260516-product-surface-ticket-validation.md`. Ralph review
`.loom/reviews/20260516-product-surface-ticket-review.md` found this ticket closeable; it
...
- 2026-05-16: Created ticket from operator disposition of `.loom/research/20260516-product-surface-scan.md` recommendation 3.
