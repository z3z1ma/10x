...
Legacy note: Risk — medium - harness fix requires testing with real subprocess; CodeMirror extensions are well-documented
...
- `.loom/specs/mill-design-room.md` - behavior contract
- `.loom/tickets/20260526-mill-design-room.md` - completed initial implementation
...
Ticket: .loom/tickets/done/20260526-mill-dr-critical-fixes.md
...
Ticket: .loom/tickets/done/20260526-mill-dr-editor-intelligence.md

Transform the editor from a generic CodeMirror instance into a Loom-native
authoring tool:
- Record reference links: detect `.loom/tickets/<ticket-slug>.md`, `.loom/specs/<spec-slug>.md`, `.loom/knowledge/<knowledge-slug>.md` patterns,
...
Ticket: .loom/tickets/done/20260526-mill-dr-graph-hierarchy.md
...
Ticket: .loom/tickets/done/20260526-mill-dr-chat-hardening.md
...
Child tickets: .loom/tickets/done/20260526-mill-dr-critical-fixes.md

Chat works. Undo works. Selection is visible. Lines wrap. No broken interactions.

### Milestone: Intelligent

Child tickets: .loom/tickets/done/20260526-mill-dr-editor-intelligence.md, .loom/tickets/done/20260526-mill-dr-graph-hierarchy.md
...
Child tickets: .loom/tickets/done/20260526-mill-dr-chat-hardening.md
