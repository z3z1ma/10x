...
Legacy note: Risk — low - CodeMirror selection API is well-documented; chat input already accepts context

Priority: high - this is what makes the Design Room more than editor+chat side by side
Depends-On: .loom/tickets/done/20260526-mill-document-editor.md, .loom/tickets/done/20260526-mill-chat-panel.md
...
- `.loom/specs/mill-design-room.md` - REQ-013
- `.loom/tickets/20260526-mill-design-room.md` - parent plan
- `.loom/tickets/done/20260526-mill-document-editor.md` - provides the CodeMirror instance
- `.loom/tickets/done/20260526-mill-chat-panel.md` - provides the chat input that receives context
...
- `loom-mill/frontend/src/lib/design/ChatInput.svelte` - Accept context:
  ...
  - Show context preview bar above the textarea:
    ```
    📎 .loom/specs/mill-design-room.md, lines 45-47  [×]
