...
Legacy note: Risk — medium - subprocess management and worktree isolation have edge cases around cleanup, signals, and concurrent access.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan, Unit 5.
- `.loom/specs/loom-mill-factory-floor-mvp.md` REQ-004, REQ-005, REQ-006, REQ-011 - harness config, worktree isolation, pause/stop, protocol portability.
- `.loom/specs/ticket-owned-worker-handoffs.md` - worker context model; Mill preserves ticket-owned context by passing the ticket path/ID to the harness.
...
- 2026-05-25: Created from `.loom/tickets/20260525-factory-floor-mvp.md` Unit 5.
