...
Legacy note: Risk — low - layout is visual polish; core functionality works without it (Svelvet provides basic positioning)
...
- `.loom/specs/mill-shaping-canvas.md` — REQ-005 (auto-layout with manual adjustment),
  REQ-007 (progressive growth / auto-pan)
- `.loom/tickets/20260526-mill-shaping-canvas.md` — parent plan; this is Unit 8
