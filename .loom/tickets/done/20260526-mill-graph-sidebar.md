...
Legacy note: Risk — low - tree rendering from existing record data

Priority: high - the navigation/wayfinding panel
Depends-On: .loom/tickets/done/20260526-mill-design-room-shell.md
...
- `.loom/specs/mill-design-room.md` - REQ-003, REQ-004, REQ-005, REQ-015, REQ-016, REQ-017
...
- `loom-mill/frontend/src/lib/design/GraphSidebar.svelte` - The full graph sidebar:
  ...
  - Child records nested under parents:
    - Tickets with `Depends On: .loom/tickets/<ticket-slug>.md` nested under that plan
    - Tickets referencing `.loom/specs/<spec-slug>.md` shown under that spec (secondary grouping)
