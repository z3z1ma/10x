...
Legacy note: Risk — low - lightweight model call or deterministic summarizer; no durable record writes without explicit promotion.
...
- `.loom/tickets/20260525-factory-floor-mvp.md` - parent plan, Unit 8.
- `.loom/specs/loom-mill-factory-floor-mvp.md` REQ-008 - inter-iteration summary requirement.
- `.loom/research/20260524-loom-mill-software-factory.md` Finding 6 - inter-iteration processes table.
...
- 2026-05-25: Created from `.loom/tickets/20260525-factory-floor-mvp.md` Unit 8.
