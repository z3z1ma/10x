...
Legacy note: Risk — low - CSS fix with clear root cause
...
- ACC-003: Cmd+Click on a record reference updates the sidebar highlight to match
  - Evidence: Cmd+Click `.loom/specs/mill-design-room.md` in a document → sidebar highlights "Mill Design Room" under Specs
