...
Legacy note: Risk — medium - significant backend concurrency work (N workstations, worktree management, subprocess multiplexing) plus LLM integration for SPC. Mitigated by: MVP architecture is sound, each unit is independently testable, and the work is additive to existing code.
...
- `.loom/specs/mill-factory-floor.md` - behavior contract for the control room and workstation engine
- `.loom/specs/mill-scheduling-agent.md` - behavior contract for autonomous work selection
- `.loom/specs/mill-process-control.md` - behavior contract for SPC and jidoka
- `.loom/specs/mill-shipping-dock.md` - behavior contract for merge workflow
- `.loom/tickets/20260525-factory-floor-mvp.md` - completed predecessor plan (MVP)
- `.loom/decisions/project-constitution.md` - factory principles (pull, WIP, jidoka, single-piece flow)
...
Ticket: .loom/tickets/done/20260525-mill-multi-workstation.md
...
Cites: `.loom/specs/mill-factory-floor.md` REQ-001, REQ-002, REQ-009, REQ-015, REQ-017, REQ-018
...
Ticket: .loom/tickets/done/20260525-mill-log-streaming.md
...
Cites: `.loom/specs/mill-factory-floor.md` REQ-003, REQ-015
...
Ticket: .loom/tickets/done/20260525-mill-iteration-history.md
...
Cites: `.loom/specs/mill-factory-floor.md` REQ-004, REQ-005, REQ-008, REQ-017
...
Ticket: .loom/tickets/done/20260525-mill-spc-jidoka.md
...
Cites: `.loom/specs/mill-process-control.md` REQ-001 through REQ-011
...
Ticket: .loom/tickets/done/20260525-mill-scheduling-agent.md
...
Cites: `.loom/specs/mill-scheduling-agent.md` REQ-001 through REQ-009
...
Ticket: .loom/tickets/done/20260525-mill-shipping-dock.md
...
Cites: `.loom/specs/mill-shipping-dock.md` REQ-001 through REQ-011
...
Ticket: .loom/tickets/done/20260525-mill-frontend-workstations.md
...
Cites: `.loom/specs/mill-factory-floor.md` REQ-011, REQ-016
...
Ticket: .loom/tickets/done/20260525-mill-frontend-diffs-playback.md
...
Cites: `.loom/specs/mill-factory-floor.md` REQ-006, REQ-007
...
Ticket: .loom/tickets/done/20260525-mill-frontend-pipeline-complete.md
...
Cites: `.loom/specs/mill-factory-floor.md` REQ-010, REQ-012, REQ-013, REQ-014
...
Child tickets: .loom/tickets/done/20260525-mill-multi-workstation.md, .loom/tickets/done/20260525-mill-log-streaming.md, .loom/tickets/done/20260525-mill-iteration-history.md
...
Child tickets: .loom/tickets/done/20260525-mill-spc-jidoka.md, .loom/tickets/done/20260525-mill-scheduling-agent.md, .loom/tickets/done/20260525-mill-shipping-dock.md
...
Child tickets: .loom/tickets/done/20260525-mill-frontend-workstations.md, .loom/tickets/done/20260525-mill-frontend-diffs-playback.md, .loom/tickets/done/20260525-mill-frontend-pipeline-complete.md
...
- 2026-05-25: Created plan with 9 execution units across 3 milestones. Strategy: foundation → observability → intelligence → integration. Specs: `.loom/specs/mill-factory-floor.md`, `.loom/specs/mill-scheduling-agent.md`, `.loom/specs/mill-process-control.md`, `.loom/specs/mill-shipping-dock.md` all active.
