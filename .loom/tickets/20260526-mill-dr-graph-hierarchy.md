...
- **Plans** show their child tickets nested (match via ticket's `Depends On: plan:X` or plan's execution units referencing tickets)
- **Specs** show tickets that reference them (match via ticket references containing `spec:X`)
