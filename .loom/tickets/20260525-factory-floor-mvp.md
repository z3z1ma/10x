...
Legacy note: Risk — medium - new application layer with subprocess management, worktree isolation, and real-time state push; architecture change to a repo that currently ships only a Markdown skill corpus.
...
- `.loom/specs/loom-mill-factory-floor-mvp.md` - behavior contract this plan implements. All requirements and scenarios are defined there.
- `.loom/decisions/project-constitution.md` - Loom/Mill identity, factory principles, constraints.
- `roadmap:loom-mill` - strategic frame: Factory Floor before Design Office.
- `.loom/research/20260524-loom-mill-software-factory.md` - factory architecture synthesis.
- `.loom/specs/ticket-owned-worker-handoffs.md` - worker context model Mill must preserve.
- `.loom/specs/loom-driver-agent.md` - inner-loop coordinator behavior Mill can invoke through harness.
...
Ticket: .loom/tickets/done/20260525-mill-project-scaffold.md
...
Ticket: .loom/tickets/done/20260525-mill-record-parser.md
...
Ticket: .loom/tickets/done/20260525-mill-watcher.md
...
Ticket: .loom/tickets/done/20260525-mill-pipeline-ui.md
...
Ticket: .loom/tickets/done/20260525-mill-workstation-engine.md
...
Ticket: .loom/tickets/done/20260525-mill-operator-controls.md
...
Ticket: .loom/tickets/done/20260525-mill-steering.md
...
Ticket: .loom/tickets/done/20260525-mill-iteration-summary.md
...
Ticket: .loom/tickets/done/20260525-mill-backpressure-andon.md
...
Child tickets: .loom/tickets/done/20260525-mill-project-scaffold.md, .loom/tickets/done/20260525-mill-record-parser.md, .loom/tickets/done/20260525-mill-watcher.md, .loom/tickets/done/20260525-mill-pipeline-ui.md
...
Child tickets: .loom/tickets/done/20260525-mill-workstation-engine.md, .loom/tickets/done/20260525-mill-operator-controls.md, .loom/tickets/done/20260525-mill-steering.md
...
Child tickets: .loom/tickets/done/20260525-mill-iteration-summary.md, .loom/tickets/done/20260525-mill-backpressure-andon.md
...
- 2026-05-25: Created plan from `.loom/specs/loom-mill-factory-floor-mvp.md` with all blocking open questions resolved. Nine execution units, three milestones, two parallel tracks converging at operator controls.
