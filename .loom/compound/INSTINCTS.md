...
- **reset-team-role-env-for-full-pytest** (68%) [testing, pytest, environment, team, reliability]
...
- **maintain-todo-state-throughout-execution** (83%) [workflow, planning, tracking, discipline]
  ...
  - Source: local
- **check-working-tree-with-git-status** (82%) [workflow, git, state-awareness, safety]
  ...
  - Source: local
- **recover-edit-after-hash-mismatch** (80%) [workflow, editing, concurrency, recovery]
  ...
  - Source: local
- **wait-on-team-inbox-events-during-manager-loops** (77%) [workflow, team, wait, orchestration, efficiency]
  ...
  - Source: local
- **validate-focused-tests-before-full-suite** (76%) [workflow, testing, iteration, validation]
  ...
  - Source: local
- **repeat-team-merge-until-queue-state-advances** (75%) [workflow, team, merge-queue, integration, orchestration]
