...
def create_app() -> Starlette:
    return Starlette(
        ...
        routes=[
            ...
            Route("/workstations/{workstation_id}/stop", stop_workstation, methods=["POST"]),
            Route("/workstations/{workstation_id}/edit", edit_workstation_ticket, methods=["POST"]),
            Route("/workstations/{workstation_id}/acknowledge-andon", acknowledge_andon, methods=["POST"]),
